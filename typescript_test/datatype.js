...
class StaticMem {
    constructor() {
        this.str1 = "hello"; // public（默认） : 公有，可以在任何地方被访问。
        this.str2 = "world"; // protected : 受保护，可以被其自身以及其子类和父类访问。
        this.str3 = "louis"; // private : 私有，只能被其定义所在的类访问。
    }
    static disp() {
...
console.log(agriLoanObj.calculateSomething({ x: 1, y: 2, interest: 3 }, { x: 2, y: 3, interest: 4 })); // { x: 3, y: 5, interest: 7 }
/******     对象    ******/
var myObj = {
    key1: "value1",
    key2: function () { },
